...
<head>
  <title>Beauty - Beauty and Nail Salon Website Template</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="Beauty Nail Salon">
  <meta name="description" content="Beauty and Nail Salon Website Template">
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Cormorant+Upright:wght@300;400;500;600;700&family=Jost:ital,wght@0,100..900;1,100..900&family=Lora:ital,wght@0,400..700;1,400..700&display=swap"
    rel="stylesheet">
...
<body>
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
              ...
              <li class="nav-item px-3 py-2 py-lg-0 dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                  ...
                  <li><a href="services-single.html" class="dropdown-item">Service-Details</a></li>
                </ul>
              </li>
              <li class="nav-item px-3 py-2 py-lg-0">
  ...
  <section id="banner" class="jarallax position-relative" style="background-image: none; background-size: cover; background-repeat: no-repeat;
  background-position: center center;" data-jarallax-original-styles="background-image: url(images/background3.jpg); background-size: cover;
  background-repeat: no-repeat; background-position: center;"> 
  <div class="container-lg padding-medium">
    <div class="hero-content text-center">
      <h2 class="banner-title display-2 text-white">Appointment</h2>
      <nav class="breadcrumb d-flex justify-content-center">
        ...
        <span class="breadcrumb-item text-white banner-title active" aria-current="page">Appointment</span>
      </nav>
    </div>
  </div>
  <div id="jarallax-container-0" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; overflow: hidden; z-index: -100;
  clip-path: polygon(0 0, 100% 0, 100% 100%, 0 100%);">
    <div style="background-position: 50% 50%; background-size: cover; background-repeat: no-repeat; background-image: url(https://demo.templatesjungle.com/beauty/images/background-3.jpg);
      position: fixed; top: 0; left: 0; width: 100%; height: 100%; overflow: hidden; pointer-events: none; transform-style: preserve-3d; backface-visibility: hidden;
...
<h2 class="display-4 fw-normal mb-3">Make An Appointment</h2>
<p>Call: +62 812 3456 789 or Fill in the form below</p>
</div>
<form class="contact-form row mt-5" method="POST" action="adddata.php">
    <div class="form-input col-lg-12 d-md-flex mb-3">
        <input type="text" name="name" placeholder="Write Your Name Here" class="form-control w-100 rounded-0 border-0 ps-4 py-3 mb-2 me-3" required>
        <input type="email" name="email" placeholder="Write Your Email Here" class="form-control w-100 rounded-0 border-0 ps-4 py-3 mb-2" required>
    </div>

    <div class="form-input col-lg-12 d-md-flex mb-3">
    <input type="tel" name="phone" placeholder="Contact number" class="form-control w-100 rounded-0 border-0 ps-4 py-3 mb-2 me-3" required>
        <input type="number" name="people_count" placeholder="No of People" class="form-control w-100 rounded-0 border-0 ps-4 py-3 mb-2" required>
    </div>

    <div class="form-input col-lg-12 d-md-flex mb-3">
    <input type="date" name="appointment_date" placeholder="Appointment Date" class="form-control w-100 rounded-0 border-0 ps-4 py-3 mb-2 me-3" required>
    <input type="time" name="appointment_time" placeholder="Appointment Time" class="form-control w-100 rounded-0 border-0 ps-4 py-3 mb-2" required>
    </div>

    <div class="col-md-12 col-sm-12 mb-4">
        <textarea name="message" placeholder="Your message" rows="4" class="w-100 border-0 ps-4 py-2" required></textarea>
    </div>
    <div class="form-group col-lg-2" style="display: grid; align-items: flex-end;">
    <input type="submit" name="submit" id="submit" class="btn btn-primary" style="text-align: center; padding: 10px;">
</div>
</form>

<section style="margin: 50px 0;">
    <h4 style="text-align: center;margin: 50px 0;">Hasil Reservasi</h4>
    <div class="container">
        <table class="table table-dark">
            ...
            <tbody>
                <?php
                    ...
                    $sql_query = "SELECT * FROM reservasi";  // Pastikan nama tabel di sini benar
                    if ($result = $conn->query($sql_query)) {
                        // Jika data ada, maka kita akan menampilkan setiap baris
                        while ($row = $result->fetch_assoc()) {
                            // Menyimpan data setiap kolom
                            $id = $row['id'];
                            $name = $row['name'];
                            $email = $row['email'];
                            $phone = $row['phone'];
